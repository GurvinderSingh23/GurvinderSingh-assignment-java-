 //WAP to perform demonstrate autowire. Use Two classes, first class Employee, second department now store all employee and department details. Print employee details in order by employee salary
