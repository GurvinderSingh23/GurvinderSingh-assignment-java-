//WAP inject list of item to bean and after this arrange all of the, item name in ascending and descending order. Also remove any duplicate name of item if present
